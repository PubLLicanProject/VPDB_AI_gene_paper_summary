...
# CONFIG
STATUS_DIR = "./out/model_comparison_speacies_balanced"
OUT_DIR = "./out/model_comparison_speacies_balanced/extracted"
GENE_CSV = pathlib.Path(OUT_DIR, "Summary_Quotes_by_model.csv")
PD_CSV = pathlib.Path(OUT_DIR, "PD_rows_all_models.csv")
